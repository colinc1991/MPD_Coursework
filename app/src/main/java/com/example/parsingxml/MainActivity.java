...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void GetListOfIncidentsForChosenDate(View v)
    {
        if (v.getId() == R.id.btnIncidents)
        {
        ...
        else
        {
            try
            {
                chosenDate = new SimpleDateFormat("dd/MM/yyyy").parse(editText.getText().toString());

                // search current roadworks
                if (v.getId() == R.id.currentRoadworksButton)
                {
                    if (currentRoadworks != null)
                    {
                        ...
                        {
                            if (IsBetweenTwoDates(o.getDateStartDate(), o.getDateEndDate(), chosenDate))
                            {
                                relevantRoadworks.add(o);
                            }
                        }
                        ...
                        {
                            showtbDialog("No current roadworks to show for that date.");
                        }
                    }
                ...
                else
                {
                    if (plannedRoadworks != null)
                    {
                        ...
                        if (relevantRoadworks.size() == 0)
                        {
                            showtbDialog("No planned roadworks to show for that date.");
                        }
                    }
            ...
            {
                showtbDialog("Please input a date in the format dd/mm/yyyy");
            }
        }
    }
    ...
    public void onClick(View clickedButton)
    {
        ...
        {
            GetListOfIncidentsForChosenDate(clickedButton);
    ...
    {
        new Thread(new Task(urlSourceCurrentRoadworks)).start();
    }
    ...
    {
        Button nextButton = (Button) findViewById(R.id.btnDateSearch);
